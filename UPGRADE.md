...
> **Важно для Home Center 0.48.0:** опубликованную редакцию автоматического updater не следует использовать как Stable-only путь до выпуска квалифицированного исправления. В текущей опубликованной редакции источник release metadata по умолчанию не ограничен официальным Stable-каналом. Для обновления 0.48.0 выбирайте артефакт явно только из официального `home-center-stable`, проверяйте release identity и контрольные суммы и не переходите к следующему узлу при любой ошибке проверки.
