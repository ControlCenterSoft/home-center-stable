...
Важно: опубликованный `v0.49.0` auto-updater всё ещё не ограничен Stable-only каналом по умолчанию. До qualification и публикации исправления обновление выполняйте только по явно выбранному и проверенному артефакту из `home-center-stable`.
